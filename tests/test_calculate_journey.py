...
class TestGetNewJourneyId(TestCase):
    ...
    def test_none_return(self, mock_get_max_journey_id=None):
    ...
    @mock.patch('db_utils.DbQuery.get_max_journey_id')
    def test_int_return(self, mock_get_max_journey_id=None):
...
class TestGetDistance(TestCase):
    ...
    def test_addresses_incorrect(self, mock_check_address, mock_get_journey_data):
